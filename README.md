...
| -------------------------------------------- | ----------- | --------------------------------------------------------------------------------- |
| RTX 5090 (next-gen) / Future RX Flagship*    | 8K+         | Ultra-high headroom, full pipeline with the heaviest shader workloads             |
...
<p align="center"><b>Enjoying the project? Drop a ⭐ It would mean a lot as it keeps me inspired to continue working for more improvements.</b></p>
</p>
