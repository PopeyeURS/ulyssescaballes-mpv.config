...
Instructions on how to enable MPV to directly open and play YouTube streams from a web browser **(Enabled only on a Firefox browser or any of its variant)**:  
