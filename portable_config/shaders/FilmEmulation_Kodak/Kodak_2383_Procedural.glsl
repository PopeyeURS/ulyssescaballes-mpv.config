//!HOOK OUTPUT
//!BIND HOOKED
//!DESC Kodak 2383 Procedural Film Curve + Microtexture + Grain + Bloom

// --- Kodak-style curve - Polished by Ulysses ---
...
vec3 highlight_bloom(vec2 uv, vec3 color) {
    ...
    // lightweight blur: sample 2 neighbors
...
vec4 hook() {
    ...
    return vec4(clamp(bloomed,0.0,1.0), src.a);
}
