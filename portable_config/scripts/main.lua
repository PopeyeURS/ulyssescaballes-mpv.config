...
-- ======
-- 🎧 PURE MODE
-- Untouched playback for reference
-- ======
local pure_filters = {}
...
local cinema_filters = {
    ...
    "acompressor=threshold=-14dB:ratio=1.4:attack=12:release=320",
    "bass=g=3:f=80",
...
local music_filters = {
    ...
    "extrastereo=level=1.2",
    "bass=g=6:f=80",
    "equalizer=f=8500:g=1.2",
    "equalizer=f=12000:g=0.5"
}
