...
local function build_ir()
    local path = expand("scripts/sofalizer/ir/theatre_ir_stereo_48k.wav")
...
local function apply_chain()
    ...
    -- Impact body (low-mid punch)
    mp.commandv("no-osd", "af", "add", "equalizer=f=200:t='l':w=0.8:g=1.5")

    -- Warmth / fullness (upper low-mid)
